...
def init_args():
    ...
    #ocr
    parser.add_argument( "--config", default='', help="Path to ocr config file")
    parser.add_argument( "--inference-results", default='./inference_results', help="Path to output folder")
    parser.add_argument( "--weight-ocr", default="./vietocr/weights/vgg_seq2seq.pth", help="Path to ocr weight")
